...
'''--------------------------------SEND-EMAIL--------------------------------'''
def send_unauthorized_email(image_path, recipient_email):
    sender = "idx240604@gmail.com"
    password = 'xsjy eiih ahlk aiko'
    subject = "Unauthorized Access Detected"
    body = "An unauthorized user has been detected. Please see the attached image."
...
def check_registered_users(frame, recipient_email="merwinofficial24@gmail.com"):
    ...
    if label == 1:
        ...
        # Send the email with the unauthorized image
        send_unauthorized_email(unauthorized_image_path, recipient_email)
        start_keylogger()
        ...
        send_unauthorized_email(spoofed_image_path, recipient_email)
        start_keylogger()
